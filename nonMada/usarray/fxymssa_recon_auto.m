function [ D1 ] = fxymssa_recon_auto(D,MASK,flow,fhigh,dt,N,Niter,eps,verb,mode,amode,a,eps2)
%  FXYMSSA_RECON_AUTO: F-XY domain multichannel singular spectrum analysis (MSSA) for
