...
alpha=1.2;           % ÔëÒô±ê×¼²îµÄalpha±¶ãÐÖµ£¨1.2×óÓÒ½ÏÎªÀíÏë£©
alpha=1.2;
niter=10;
...
set(gca,'Linewidth',2,'Fontsize',30);
print(gcf,'-depsc','-r200','sigmas_dn1.eps');
...
% title('Noise','Fontsize',30);
set(gca,'Linewidth',2,'Fontsize',30);
print(gcf,'-depsc','-r200','sigmas_dn2.eps');
...
% title('Noise','Fontsize',30);
set(gca,'Linewidth',2,'Fontsize',30);
print(gcf,'-depsc','-r200','sigmas_dn3.eps');
...
% title('Noise','Fontsize',30);
set(gca,'Linewidth',2,'Fontsize',30);
print(gcf,'-depsc','-r200','sigmas_dn4.eps');
...
% title('Noise','Fontsize',30);
set(gca,'Linewidth',2,'Fontsize',30);
print(gcf,'-depsc','-r200','sigmas_d41.eps');
...
% title('Noise','Fontsize',30);
set(gca,'Linewidth',2,'Fontsize',30);
print(gcf,'-depsc','-r200','sigmas_d42.eps');
...
% title('Noise','Fontsize',30);
set(gca,'Linewidth',2,'Fontsize',30);
print(gcf,'-depsc','-r200','sigmas_d43.eps');
...
% title('Noise','Fontsize',30);
set(gca,'Linewidth',2,'Fontsize',30);
print(gcf,'-depsc','-r200','sigmas_d44.eps');
