function Weiyuan(dtimes,dtimes2,data,label,location_name,Nevents,Nstations)
...
times2=zeros(101,101*Nevents);
rsf_read(times,dtimes);
rsf_read(times2,dtimes2);
times=reshape(times,101,101,Nevents);
times2=reshape(times2,101,101,Nevents);
...
data222=zeros(4,Nstations,Nevents);%[x,y,t] x Nstation x Nevent
