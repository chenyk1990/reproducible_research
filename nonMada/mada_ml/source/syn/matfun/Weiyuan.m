function Weiyuan(dtimes,deltav,data,label,location_name,Nevents,Nstations,Nz)
...
label_location_dv=[label_location;dv];
...
rsf_create(label,size(label_location_dv)');
rsf_write(label_location_dv,label);
