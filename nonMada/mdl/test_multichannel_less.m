...
figure;
subplot(1,2,1);yc_wigb(d(:,1:4:end),1,1:2,t);
xlabel('Channel','Fontsize',16);
ylabel('Time (ms)','Fontsize',16);
set(gca,'Linewidth',1.5,'Fontsize',16);
title('(a)','Fontsize',16);

subplot(1,2,2);yc_wigb(dn(:,1:4:end),1,1:2,t);
xlabel('Channel','Fontsize',16);
% ylabel('Time (ms)','Fontsize',16);
set(gca,'Linewidth',1.5,'Fontsize',16);
title('(b)','Fontsize',16);
print(gcf,'-depsc','-r300','syn22.eps');
...
set(gca,'Linewidth',1.5,'Fontsize',16);
title('(b)','Fontsize',16);
print(gcf,'-depsc','-r300','syn22_d.eps');

figure('units','normalized','Position',[0.2 0.4 0.4, 0.6]);
subplot(4,1,1);plot(t,d2(:,ix),'b','linewidth',2);ylim([-1.5,1.5]);xlim([0,t(end)]);
ylabel('Amplitude','Fontsize',16);
set(gca,'Linewidth',1.5,'Fontsize',16);
title('(a)','Fontsize',16);

subplot(4,1,2);plot(t,d1(:,ix),'b','linewidth',2);ylim([-1.5,1.5]);xlim([0,t(end)]);
ylabel('Amplitude','Fontsize',16);
set(gca,'Linewidth',1.5,'Fontsize',16);
title('(b)','Fontsize',16);

subplot(4,1,3);plot(t,dn(:,ix)-d2(:,ix),'b','linewidth',2);ylim([-1.5,1.5]);xlim([0,t(end)]);
ylabel('Amplitude','Fontsize',16);
set(gca,'Linewidth',1.5,'Fontsize',16);
title('(c)','Fontsize',16);

subplot(4,1,4);plot(t,dn(:,ix)-d1(:,ix),'b','linewidth',2);ylim([-1.5,1.5]);xlim([0,t(end)]);
ylabel('Amplitude','Fontsize',16);
xlabel('Time (ms)','Fontsize',16);
title('(d)','Fontsize',16);
set(gca,'Linewidth',1.5,'Fontsize',16);
% annotation('textarrow',[0.6,0.66],[0.45,0.41],'color','r','linewidth',2,'Fontsize',20,'fontweight','bold');
print(gcf,'-depsc','-r300','syn22_dn.eps');
...
set(gca,'Linewidth',1.5,'Fontsize',16);
print(gcf,'-depsc','-r300','syn22_Gksvd0.eps');
...
title('Coefficients Matrix','Fontsize',16);
set(gca,'Linewidth',1.5,'Fontsize',16);
print(gcf,'-depsc','-r300','syn22_G.eps');
...
title('Coefficients Matrix','Fontsize',16);
set(gca,'Linewidth',1.5,'Fontsize',16);
print(gcf,'-depsc','-r300','syn22_Gksvd.eps');
...
set(gca,'Linewidth',1.5,'Fontsize',16);
print(gcf,'-depsc','-r300','syn22_Dct.eps');
...
title('Dictionary Atoms','Fontsize',16);
set(gca,'Linewidth',1.5,'Fontsize',16);
print(gcf,'-depsc','-r300','syn22_Dksvd.eps');
...
set(gca,'Linewidth',1.5,'Fontsize',16);
print(gcf,'-depsc','-r300','syn22_X.eps');
...
title('Patches','Fontsize',16);
set(gca,'Linewidth',1.5,'Fontsize',16);
print(gcf,'-depsc','-r300','syn22_X1.eps');
...
print(gcf,'-depsc','-r300','syn22_atoms.eps');
...
%     xlim([1,l1]);
% end
% print(gcf,'-depsc','-r300','syn22_atoms1.eps');
