function [DATA_f] = fxdecon(DATA,flow,fhigh,dt,lf,mu,verb);
%FXDECON: SNR enhancement using fx-deconvolution/fx predictive filtering.
%
%  [DATA_f] = fxdecon(DATA,flow,fhigh,dt,lf,mu,verb)
% 
