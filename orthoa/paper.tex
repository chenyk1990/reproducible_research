...
\begin{figure}[htb!]
\centering
\subfigure[]{\includegraphics[width=0.31\columnwidth]{complex/Fig/c}
   \label{fig:c}}
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{complex/Fig/n}
   \label{fig:n}}
\subfigure[]{\includegraphics[width=0.31\columnwidth]{complex/Fig/cn}
   \label{fig:cn}}\\
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{complex/Fig/cfx}
   \label{fig:cfx}}
\subfigure[]{\includegraphics[width=0.31\columnwidth]{complex/Fig/cfx2}
   \label{fig:cfx2}}
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{complex/Fig/cfx22}
   \label{fig:cfx22}}\\  
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{complex/Fig/cdifffx}
   \label{fig:cdifffx}}
\subfigure[]{\includegraphics[width=0.31\columnwidth]{complex/Fig/cdifffx2}
   \label{fig:cdifffx2}}
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{complex/Fig/cdifffx22}
   \label{fig:cdifffx22}}
...
\begin{figure}[htb!]
\centering
\subfigure[]{\includegraphics[width=0.31\columnwidth]{complex/Fig/csimi-difffx}
   \label{fig:csimi-difffx}}
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{complex/Fig/csimi-difffx2}
   \label{fig:csimi-difffx2}}
\subfigure[]{\includegraphics[width=0.31\columnwidth]{complex/Fig/csimi-difffx22}
...
\begin{figure}[htb!]
\centering
\subfigure[]{\includegraphics[width=0.31\columnwidth]{csimul/Fig/huo}
   \label{fig:huo}}
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{csimul/Fig/huo-noise}
   \label{fig:huo-noise}}
\subfigure[]{\includegraphics[width=0.31\columnwidth]{csimul/Fig/huos}
   \label{fig:huos}}\\
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{csimul/Fig/huos-mf}
   \label{fig:huos-mf}}
\subfigure[]{\includegraphics[width=0.31\columnwidth]{csimul/Fig/huos-ortho}
   \label{fig:huos-ortho}}
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{csimul/Fig/huos-ortho2}
   \label{fig:huos-ortho2}}\\  
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{csimul/Fig/huosdiff-mf}
   \label{fig:huosdiff-mf}}
\subfigure[]{\includegraphics[width=0.31\columnwidth]{csimul/Fig/huosdiff-ortho}
   \label{fig:huosdiff-ortho}}
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{csimul/Fig/huosdiff-ortho2}
...
\begin{figure}[htb!]
\centering
\subfigure[]{\includegraphics[width=0.31\columnwidth]{csimul/Fig/huos-simi}
   \label{fig:huos-simi}} 
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{csimul/Fig/huos-simi-ortho}
   \label{fig:huos-simi-ortho}}
\subfigure[]{\includegraphics[width=0.31\columnwidth]{csimul/Fig/huos-simi-ortho2}
...
\begin{figure}[htb!]
\centering
\subfigure[]{\includegraphics[width=0.31\columnwidth]{nine/Fig/pp-fx}
   \label{fig:pp-fx}}
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{nine/Fig/pp-ortho}
   \label{fig:pp-ortho}}
\subfigure[]{\includegraphics[width=0.31\columnwidth]{nine/Fig/pp-ortho2}
   \label{fig:pp-ortho2}}\\
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{nine/Fig/ppdiff-fx0}
   \label{fig:ppdiff-fx0}}
\subfigure[]{\includegraphics[width=0.31\columnwidth]{nine/Fig/ppdiff-ortho0}
   \label{fig:ppdiff-ortho0}}
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{nine/Fig/ppdiff-ortho20}
   \label{fig:ppdiff-ortho20}}\\  
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{nine/Fig/pp-simi}
   \label{fig:pp-simi}}
\subfigure[]{\includegraphics[width=0.31\columnwidth]{nine/Fig/pp-simi-ortho}
   \label{fig:pp-simi-ortho}}
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{nine/Fig/pp-simi-ortho2}
...
\begin{figure}[htb!]
\centering
\subfigure[]{\includegraphics[width=0.8\columnwidth]{rna/Fig/data0}
   \label{fig:data0}}\\
   \subfigure[]{\includegraphics[width=0.45\columnwidth]{rna/Fig/zoom-data-a}
   \label{fig:zoom-data-a}}
\subfigure[]{\includegraphics[width=0.45\columnwidth]{rna/Fig/zoom-data-b}
...
\begin{figure}[htb!]
\centering
\subfigure[]{\includegraphics[width=0.31\columnwidth]{rna/Fig/npre0}
   \label{fig:npre0}}
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{rna/Fig/rna-ortho0}
   \label{fig:rna-ortho0}}
\subfigure[]{\includegraphics[width=0.31\columnwidth]{rna/Fig/rna-ortho20}
   \label{fig:rna-ortho20}}\\
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{rna/Fig/nprediff0}
   \label{fig:nprediff0}}
\subfigure[]{\includegraphics[width=0.31\columnwidth]{rna/Fig/rnadiff-ortho0}
   \label{fig:rnadiff-ortho0}}
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{rna/Fig/rnadiff-ortho20}
   \label{fig:rnadiff-ortho20}}\\  
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{rna/Fig/rna-simi}
   \label{fig:rna-simi}}
\subfigure[]{\includegraphics[width=0.31\columnwidth]{rna/Fig/rna-simi-ortho}
   \label{fig:rna-simi-ortho}}
   \subfigure[]{\includegraphics[width=0.31\columnwidth]{rna/Fig/rna-simi-ortho2}
...
\begin{figure}[htb!]
\centering
\subfigure[]{\includegraphics[width=0.45\columnwidth]{rna/Fig/zoom-npre-a}
   \label{fig:zoom-npre-a}}
   \subfigure[]{\includegraphics[width=0.45\columnwidth]{rna/Fig/zoom-npre-b}
   \label{fig:zoom-npre-b}}\\
\subfigure[]{\includegraphics[width=0.45\columnwidth]{rna/Fig/zoom-rna-ortho-a}
   \label{fig:zoom-rna-ortho-a}}
   \subfigure[]{\includegraphics[width=0.45\columnwidth]{rna/Fig/zoom-rna-ortho2-b}
   \label{fig:zoom-rna-ortho-b}}\\
\subfigure[]{\includegraphics[width=0.45\columnwidth]{rna/Fig/zoom-rna-ortho2-a}
...
\begin{figure}[htb!]
\centering
\subfigure[]{\includegraphics[width=0.45\columnwidth]{rna/Fig/zoom-rnadif-a}
   \label{fig:zoom-rnadif-a}}
   \subfigure[]{\includegraphics[width=0.45\columnwidth]{rna/Fig/zoom-rnadif-b}
   \label{fig:zoom-rnadif-b}}\\
\subfigure[]{\includegraphics[width=0.45\columnwidth]{rna/Fig/zoom-orthodif-a}
   \label{fig:zoom-orthodif-a}}
   \subfigure[]{\includegraphics[width=0.45\columnwidth]{rna/Fig/zoom-orthodif-b}
   \label{fig:zoom-orthodif-b}}\\
\subfigure[]{\includegraphics[width=0.45\columnwidth]{rna/Fig/zoom-ortho2dif-a}
   \label{fig:zoom-ortho2dif-a}}
   \subfigure[]{\includegraphics[width=0.45\columnwidth]{rna/Fig/zoom-ortho2dif-b}
