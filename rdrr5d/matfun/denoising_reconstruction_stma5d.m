function [ D1 ] = denoising_reconstruction_stma5d(D,MASK,flow,fhigh,dt,Niter,eps,verb,mode,a,K,e,ws)
%  STMA: Soft thresholding moving-average (STMA) filter for 5D
...
function [dout]=P_STMA(din,K,e,ws)

dout=STMA(din,K,e,ws);
return
