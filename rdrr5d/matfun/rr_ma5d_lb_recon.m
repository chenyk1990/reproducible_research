function [ D1 ] = rr_ma5d_lb_recon(D,MASK,flow,fhigh,dt,N,Niter,eps,verb,mode,a,e,ws)
%  RR + MA: Rank-reduction (RR) method + moving average (MA) filter for simultaneous denoising and 
