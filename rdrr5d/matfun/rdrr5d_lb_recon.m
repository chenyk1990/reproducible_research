function [ D1 ] = denoising_recon_rdrr(D,MASK,flow,fhigh,dt,N,NN,Niter,eps,verb,mode,iflb,a,K,e,ws)
%  RDRR: Robust damped rank-reduction (RDRR) method for simultaneous denoising and 
...
function [dout]=P_R(din,N,iflb,NN,K,e,ws)
