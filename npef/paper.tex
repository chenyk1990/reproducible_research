...
%\begin{figure}[htb!]
%    \centering
%    \subfloat[]{\includegraphics[width=\textwidth]{real5d_onestep/Fig/os_obs}
%    \label{fig:os_obs}}\\
%    \subfloat[]{\includegraphics[width=\textwidth]{real5d_onestep/Fig/os_recon}
%    \label{fig:os_recon}}\\
%    \subfloat[]{\includegraphics[width=\textwidth]{real5d_onestep/Fig/ts_recon}
%    \label{fig:ts_recon}}
