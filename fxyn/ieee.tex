...
\begin{figure}[htb!]
\centering
\subfigure[]{\includegraphics[width=0.32\textwidth]{hyper3d/Fig/cmp0}
\label{fig:cmp0}}
\subfigure[]{\includegraphics[width=0.32\textwidth]{hyper3d/Fig/cmp}
\label{fig:cmp}}
...
\begin{figure}[htb!]
\centering
\subfigure[]{\includegraphics[width=0.31\textwidth]{hyper3d/Fig/test2-0}
\label{fig:test2-0}}
\subfigure[]{\includegraphics[width=0.31\textwidth]{hyper3d/Fig/test1-0}
\label{fig:test1-0}}\\
\subfigure[]{\includegraphics[width=0.31\textwidth]{hyper3d/Fig/test00-0}
\label{fig:test00-0}}
\subfigure[]{\includegraphics[width=0.31\textwidth]{hyper3d/Fig/test3-0}
\label{fig:test3-0}}
...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.5\textwidth]{hyper3d/Fig/rect1}
...
\begin{figure}[htb!]
\centering
\subfigure[]{\includegraphics[width=0.31\textwidth]{hyper3d/Fig/test2dif-0}
\label{fig:test2dif-0}}
\subfigure[]{\includegraphics[width=0.31\textwidth]{hyper3d/Fig/test1dif-0}
\label{fig:test1dif-0}}\\
\subfigure[]{\includegraphics[width=0.31\textwidth]{hyper3d/Fig/test00dif-0}
\label{fig:test0dif-0}}
\subfigure[]{\includegraphics[width=0.31\textwidth]{hyper3d/Fig/test3dif-0}
...
\begin{figure}[htb!]
\centering
\subfigure[]{\includegraphics[width=0.30\textwidth]{hyper3d/Fig/simi2}
\label{fig:simi2}}
\subfigure[]{\includegraphics[width=0.30\textwidth]{hyper3d/Fig/simi1}
\label{fig:simi1}}\\
\subfigure[]{\includegraphics[width=0.30\textwidth]{hyper3d/Fig/simi00}
\label{fig:simi0}}
\subfigure[]{\includegraphics[width=0.30\textwidth]{hyper3d/Fig/simi3}
\label{fig:simi00}}
...
\begin{figure*}[ht!]
\centering
\subfigure[]{\includegraphics[width=0.30\textwidth]{hyper3d/Fig/hyper-f}
\label{fig:hyper-f}}
\subfigure[]{\includegraphics[width=0.30\textwidth]{hyper3d/Fig/hypern-f}
\label{fig:hypern-f}}
\subfigure[]{\includegraphics[width=0.30\textwidth]{hyper3d/Fig/test2-f}
\label{fig:test2-f}}\\
\subfigure[]{\includegraphics[width=0.30\textwidth]{hyper3d/Fig/test1-f}
\label{fig:test1-f}}
\subfigure[]{\includegraphics[width=0.30\textwidth]{hyper3d/Fig/test00-f}
\label{fig:test00-f}}
\subfigure[]{\includegraphics[width=0.30\textwidth]{hyper3d/Fig/test3-f}
\label{fig:test3-f}}
...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.45\textwidth]{real2d/Fig/real2d-0}
...
\begin{figure*}[ht!]
\centering
\subfigure[]{\includegraphics[width=0.350\textwidth]{real2d/Fig/r2test2-0}
\label{fig:r2test2-0}}
\subfigure[]{\includegraphics[width=0.350\textwidth]{real2d/Fig/r2test1-0}
\label{fig:r2test1-0}}\\
\subfigure[]{\includegraphics[width=0.350\textwidth]{real2d/Fig/r2test00-0}
\label{fig:r2test00-0}}
\subfigure[]{\includegraphics[width=0.350\textwidth]{real2d/Fig/r2test3-0}
\label{fig:r2test3-0}}
...
\begin{figure*}[ht!]
\centering
\subfigure[]{\includegraphics[width=0.350\textwidth]{real2d/Fig/r2test2-n}
\label{fig:r2test2-n}}
\subfigure[]{\includegraphics[width=0.350\textwidth]{real2d/Fig/r2test1-n}
\label{fig:r2test1-n}}\\
\subfigure[]{\includegraphics[width=0.350\textwidth]{real2d/Fig/r2test00-n}
\label{fig:r2test00-n}}
\subfigure[]{\includegraphics[width=0.350\textwidth]{real2d/Fig/r2test3-n}
\label{fig:r2test3-n}}
\caption{Removed noise using (a) stationary predictive filtering, (b) regularized non-stationary auto-regression, (c) non-stationary predictive filtering with frequency-dependent smoothing, and (d) non-stationary predictive filtering with frequency-space-dependent smoothing.}
...
\begin{figure*}[ht!]
\centering
\subfigure[]{\includegraphics[width=0.350\textwidth]{real2d/Fig/r2simi2}
\label{fig:r2simi2}}
\subfigure[]{\includegraphics[width=0.350\textwidth]{real2d/Fig/r2simi1}
\label{fig:r2simi1}}\\
\subfigure[]{\includegraphics[width=0.350\textwidth]{real2d/Fig/r2simi00}
\label{fig:r2simi00}}
\subfigure[]{\includegraphics[width=0.350\textwidth]{real2d/Fig/r2simi3}
\label{fig:r2simi3}}
\caption{Local similarity (between denoised data and removed noise) using (a) stationary predictive filtering, (b) regularized non-stationary auto-regression, (c) non-stationary predictive filtering with frequency-dependent smoothing, and (d) non-stationary predictive filtering with frequency-space-dependent smoothing.}
...
\begin{figure*}[ht!]
\centering
\subfigure[]{\includegraphics[width=0.30\textwidth]{real2d/Fig/real2d-z}
\label{fig:real2d-z}}
\subfigure[]{\includegraphics[width=0.30\textwidth]{real2d/Fig/r2test2-z}
\label{fig:r2test2-z}}
\subfigure[]{\includegraphics[width=0.30\textwidth]{real2d/Fig/r2test1-z}
\label{fig:r2test1-z}}\\
\subfigure[]{\includegraphics[width=0.30\textwidth]{real2d/Fig/r2test00-z}
\label{fig:r2test00-z}}
\subfigure[]{\includegraphics[width=0.30\textwidth]{real2d/Fig/r2test3-z}
\label{fig:r2test3-z}}
...
\begin{figure}[htb!]
\centering
\subfigure[]{\includegraphics[width=0.355\textwidth]{real3d/Fig/real}}
...
\begin{figure*}[ht!]
\centering
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rtest2}
\label{fig:rtest2}}
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rtest1}
\label{fig:rtest1}}\\
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rtest00}
\label{fig:rtest00}}
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rtest3}
\label{fig:rtest3}}
\caption{Denoised data using (a) stationary predictive filtering, (b) regularized non-stationary auto-regression, (c) non-stationary predictive filtering with frequency-dependent smoothing, and (d) non-stationary predictive filtering with frequency-space-dependent smoothing.}
...
\begin{figure*}[ht!]
\centering
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rtest2-n}
\label{fig:rtest2-n}}
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rtest1-n}
\label{fig:rtest1-n}}\\
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rtest00-n}
\label{fig:rtest00-n}}
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rtest3-n}
\label{fig:rtest3-n}}
\caption{Removed noise using (a) stationary predictive filtering, (b) regularized non-stationary auto-regression, (c) non-stationary predictive filtering with frequency-dependent smoothing, and (d) non-stationary predictive filtering with frequency-space-dependent smoothing.}
...
\begin{figure*}[ht!]
\centering
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rsimi2}
\label{fig:rsimi2}}
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rsimi1}
\label{fig:rsimi1}}\\
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rsimi00}
\label{fig:rsimi00}}
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rsimi3}
\label{fig:rsimi3}}
\caption{Local similarity (between denoised data and removed noise) using (a) stationary predictive filtering, (b) regularized non-stationary auto-regression, (c) non-stationary predictive filtering with frequency-dependent smoothing, and (d) non-stationary predictive filtering with frequency-space-dependent smoothing.}
...
\begin{figure*}[ht!]
\centering
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/real-z}
\label{fig:real-z}}
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rtest2-z}
\label{fig:rtest2-z}}\\
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rtest1-z}
\label{fig:rtest1-z}}
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rtest00-z}
\label{fig:rtest00-z}}\\
\subfigure[]{\includegraphics[width=0.38\textwidth]{real3d/Fig/rtest3-z}
\label{fig:rtest3-z}}
\caption{Zoomed comparison of denoised data using (a) raw data, (b) stationary predictive filtering, (c) regularized non-stationary auto-regression, (d) non-stationary predictive filtering with frequency-dependent smoothing, and (e) non-stationary predictive filtering with frequency-space-dependent smoothing. \old{(f) Difference between (d) and (e). Note that the frequency-space-dependent smoothing (e) has removed more high-frequency noise compared with (d).}}
