...
/*
  Copyright (C) 2014 China University of Petroleum (Beijing) and University of Texas at Austin
...
int main(int argc, char *argv[])
{
	...
	sum=sum/n1/n2;
	sf_warning("Current data misfit is %g",sum);
	misfit[iter]=sum;	
	...
	if (verb) sf_warning("Current iteration is %d/%d;",iter+1,niter);	
    }
