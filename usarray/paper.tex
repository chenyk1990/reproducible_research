...
%\begin{figure*}[ht!]
%	\centering
%	\subfigure[]{\includegraphics[width=0.22\textwidth]{Fig/syn-jw-vp}
%    \label{fig:syn-jw-vp}}
%    \subfigure[]{\includegraphics[width=0.22\textwidth]{Fig/syn-jw-vs}
%    \label{fig:syn-jw-vs}}
%    \subfigure[]{\includegraphics[width=0.22\textwidth]{Fig/syn-jw-rho}
%    \label{fig:syn-jw-rho}}\\
%    \subfigure[]{\includegraphics[width=0.6\textwidth]{Fig/observation}
%    \label{fig:obs}}
...
%\begin{figure*}[ht!]
%	\centering
%	\subfigure[]{\includegraphics[width=0.22\textwidth]{Fig/syn-jw-clean}
%    \label{fig:syn-clean}}
%    \subfigure[]{\includegraphics[width=0.22\textwidth]{Fig/syn-jw-noisy}
%    \label{fig:syn-noisy}}
%    \subfigure[]{\includegraphics[width=0.22\textwidth]{Fig/syn-jw-mask}
%    \label{fig:syn-mask}}
%    \subfigure[]{\includegraphics[width=0.22\textwidth]{Fig/syn-jw-obs}
%    \label{fig:syn-obs}}
...
%\begin{figure*}[ht!]
%	\centering
%	\subfigure[]{\includegraphics[width=0.22\textwidth]{Fig/syn-jw-rr}
%    \label{fig:syn-rr}}
%    \subfigure[]{\includegraphics[width=0.22\textwidth]{Fig/syn-jw-lrr}
%    \label{fig:syn-lrr}}
%    \subfigure[]{\includegraphics[width=0.22\textwidth]{Fig/syn-jw-rr-e}
%    \label{fig:syn-rr-e}}
%    \subfigure[]{\includegraphics[width=0.22\textwidth]{Fig/syn-jw-lrr-e}
%    \label{fig:syn-lrr-e}}
...
%\begin{figure*}[ht!]
%	\centering
%	\subfigure[]{\includegraphics[width=0.4\textwidth]{Fig/syn-jw-ss-0}
%    \label{fig:syn-ss-0}}
%    \subfigure[]{\includegraphics[width=0.4\textwidth]{Fig/syn-jw-ss-z}
%    \label{fig:syn-ss-z}}
...
%\begin{figure*}[ht!]
%	\centering
%	\subfigure[]{\includegraphics[width=0.25\textwidth]{Fig/syn-jw-rr-simi}
%    \label{fig:syn-rr-simi}}
%    \subfigure[]{\includegraphics[width=0.25\textwidth]{Fig/syn-jw-lrr-simi}
%    \label{fig:syn-lrr-simi}}
...
%\begin{figure*}[ht!]
%	\centering
%	\includegraphics[width=0.4\textwidth]{Fig/snr-jw-n}
...
\plot{ttres_vel}{width=0.7\textwidth}{\old{P-wave relative travel time residuals across the recording array measured from (a) the original and (b) the reconstructed data.}\new{A comparison of P-wave travel time measurements between the original and reconstructed data. (a) Relative travel time residuals across the recording array measured from the original data. (b) Relative travel time residuals measured from the reconstructed data.} Measurements with uncertainties larger than one standard deviation of the cross-correlation error are \dlo{shaded in gray}\wen{represented by gray circles} in (b). The brown lines indicate the boundaries of major tectonic domains in \wen{the} western US. (c) Average P-wave velocity perturbations between 50-250 km depths from \wen{Schmandt and Lin (2014)} \cite{schmandt2014p}.}

\plot{raw_ssa_tt}{width=0.7\textwidth}{ \new{A comparison of travel time measurement uncertainties.}\old{Travel time measurement uncertainties of (a) the original and (b) the reconstructed data.}\new{ (a) Travel time plot of the original data. (b) Travel time plot of the reconstructed data.} Both measured and predicted travel times are demeaned to emphasize the perturbations. The blue data points in (b) represent measurement outliers differing by more than 2 sec from the predictions, which are excluded from tomographic inversion in real practice.}
