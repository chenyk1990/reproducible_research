...
\published{IEEE TGRS, 59, no. 7, 6225-6233, (2021)}
...
\righthead{Non-stationary local slope estimation}
...
\begin{figure}[htb!]
\centering
\subfloat[]{\includegraphics[width=0.45\columnwidth]{hyper/Fig/hyper}
   \label{fig:hyper}}
   \subfloat[]{\includegraphics[width=0.45\columnwidth]{hyper/Fig/hyper-n}
   \label{fig:hyper-n}}
...
%\begin{figure}[htb!]
%\centering
%\subfloat[]{\includegraphics[width=0.45\columnwidth]{hyper/Fig/hyper-dip}
%  \label{fig:hyper-dip}}
%  \subfloat[]{\includegraphics[width=0.45\columnwidth]{hyper/Fig/hypern-dip}
%  \label{fig:hypern-dip}}\\
%\subfloat[]{\includegraphics[width=0.45\columnwidth]{hyper/Fig/hypern-dip2}
%  \label{fig:hypern-dip2}}
%  \subfloat[]{\includegraphics[width=0.45\columnwidth]{hyper/Fig/hypern-dip3}
...
%\begin{figure}[htb!]
%\centering
%\subfloat[]{\includegraphics[width=0.45\columnwidth]{hyper/Fig/hypern-sm1}
%   \label{fig:hypern-sm1}}
%   \subfloat[]{\includegraphics[width=0.45\columnwidth]{hyper/Fig/hypern-sm2}
%   \label{fig:hypern-sm2}}\\
%\subfloat[]{\includegraphics[width=0.45\columnwidth]{hyper/Fig/hypern-sm3}
%   \label{fig:hypern-sm3}}
%   \subfloat[]{\includegraphics[width=0.45\columnwidth]{hyper/Fig/hypern-sm4}
...
%\begin{figure}[htb!]
%\centering
%\subfloat[]{\includegraphics[width=0.45\columnwidth]{hyper/Fig/hypern-sm1-n}
%   \label{fig:hypern-sm1-n}}
%   \subfloat[]{\includegraphics[width=0.45\columnwidth]{hyper/Fig/hypern-sm2-n}
%   \label{fig:hypern-sm2-n}}\\
%\subfloat[]{\includegraphics[width=0.45\columnwidth]{hyper/Fig/hypern-sm3-n}
%   \label{fig:hypern-sm3-n}}
%   \subfloat[]{\includegraphics[width=0.45\columnwidth]{hyper/Fig/hypern-sm4-n}
...
%\end{figure}
\inputdir{hyper}
\multiplot{2}{hyper,hyper-n}{width=0.45\textwidth}{Synthetic test. (a) Clean data. (b) Noisy data (SNR=1.56 dB). }

\multiplot{4}{hyper-dip,hypern-dip,hypern-dip2,hypern-dip3}{width=0.45\textwidth}{Slope estimation results. (a) Estimated slope from the clean data with a constant smoothing radius $R=5$. (b) Estimated slope from the noisy data with a constant smoothing radius $R=8$. (c) Estimated slope from the noisy data with a constant smoothing radius $R=50$. (d) Estimated slope from the noisy data with the non-stationary smoothing radius map shown in Fig. \ref{fig:rectdip1}. Note that (b) and (c) use the smallest and largest smoothing radii of the non-stationary smoothing radius map. }



\plot{rectdip1}{width=0.45\textwidth}{Adaptively estimated smoothing radius for non-stationary dip estimation.}




\multiplot{4}{hypern-sm1,hypern-sm2,hypern-sm3,hypern-sm4}{width=0.45\textwidth}{Smoothing test. (a) Structurally smoothed using the slope estimated from the clean data (SNR=13.73 dB). (b) Structurally smoothed using the slope estimated from the noisy data with a small constant smoothing radius (SNR=11.80 dB). (c) Structurally smoothed using the slope estimated from the noisy data with a large constant smoothing radius (SNR=10.71 dB). (d) Structurally smoothed using the slope estimated from the noisy data with non-stationary smoothing radius (SNR=13.11 dB).}



\multiplot{4}{hypern-sm1-n,hypern-sm2-n,hypern-sm3-n,hypern-sm4-n}{width=0.45\textwidth}{Smoothing test. (a)-(d) Removed noise corresponding to Figs. \ref{fig:hypern-sm1}-\ref{fig:hypern-sm4}.}
...
%\begin{figure}[htb!]
%\centering
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-0}
%   \label{fig:g-0}}
%   \subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-z-a}
%   \label{fig:g-z-a}}
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-z-b}
%   \label{fig:g-z-b}}
...
%\begin{figure}[htb!]
%\centering
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-dip1}
%   \label{fig:g-dip1}}
%   \subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-dip2}
%   \label{fig:g-dip2}}
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-dip3}
%   \label{fig:g-dip3}}
...
%\begin{figure}[htb!]
%\centering
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-sm1-0}
%  \label{fig:g-sm1-0}}
%  \subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-sm2-0}
%  \label{fig:g-sm2-0}}
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-sm3-0}
%  \label{fig:g-sm3-0}}
...
%\begin{figure}[htb!]
%\centering
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-sm1-n}
%  \label{fig:g-sm1-n}}
%  \subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-sm2-n}
%  \label{fig:g-sm2-n}}
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-sm3-n}
%  \label{fig:g-sm3-n}}
...
%\begin{figure}[htb!]
%\centering
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-sm1-z-a0}
% \label{fig:g-sm1-z-a0}}
% \subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-sm2-z-a0}
% \label{fig:g-sm2-z-a0}}
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-sm3-z-a0}
...
%\begin{figure}[htb!]
%\centering
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-sm1-z-b0}
%  \label{fig:g-sm1-z-b0}}
%  \subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-sm2-z-b0}
%  \label{fig:g-sm2-z-b0}}
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real2d/Fig/g-sm3-z-b0}
...
\inputdir{real2d}
\multiplot{3}{g-0,g-z-a,g-z-b}{width=0.45\textwidth}{Field data example. (a) Raw field data. (b) Zoomed section A. (c) Zoomed section B.}

\plot{g-rectdip1}{width=0.45\textwidth}{Field data example. Non-stationary smoothing radius.}



\multiplot{3}{g-dip1,g-dip2,g-dip3}{width=0.45\textwidth}{Smoothing test of the field data example. (a) Slope estimated from the noisy data with a small constant smoothing radius $R=8$. (b) Slope estimated from the noisy data with a large constant smoothing radius $R=100$. (c) Slope estimated from the noisy data with non-stationary smoothing radius.}


\multiplot{3}{g-sm1-0,g-sm2-0,g-sm3-0}{width=0.45\textwidth}{Smoothing test of the field data example. (a) Structurally smoothed using the slope estimated from the noisy data with a small constant smoothing radius. (b) Structurally smoothed using the slope estimated from the noisy data with a large constant smoothing radius. (c) Structurally smoothed using the slope estimated from the noisy data with non-stationary smoothing radius.}


\multiplot{3}{g-sm1-n,g-sm2-n,g-sm3-n}{width=0.45\textwidth}{Smoothing test of the field data example. (a)-(c) Removed noise corresponding to Figs. \ref{fig:g-sm1-0}-\ref{fig:g-sm3-0}.}


\multiplot{3}{g-sm1-z-a0,g-sm2-z-a0,g-sm3-z-a0}{width=0.45\textwidth}{Zoomed comparison of the field data example (frame box A). (a) Structurally smoothed using the slope estimated from the noisy data with a small constant smoothing radius. (b) Structurally smoothed using the slope estimated from the noisy data with a large constant smoothing radius. (c) Structurally smoothed using the slope estimated from the noisy data with non-stationary smoothing radius.}

\multiplot{3}{g-sm1-z-b0,g-sm2-z-b0,g-sm3-z-b0}{width=0.45\textwidth}{Zoomed comparison of the field data example (frame box B). (a) Structurally smoothed using the slope estimated from the noisy data with a small constant smoothing radius. (b) Structurally smoothed using the slope estimated from the noisy data with a large constant smoothing radius. (c) Structurally smoothed using the slope estimated from the noisy data with non-stationary smoothing radius.}
...
%\begin{figure}[htb!]
%\centering
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real3d/Fig/real-s2dip1}
%   \label{fig:real-s2dip1}}
%   \subfloat[]{\includegraphics[width=0.45\textwidth]{real3d/Fig/real-s1dip1}
%   \label{fig:real-s1dip1}}
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real3d/Fig/real-ndip1}
...
%\begin{figure}[htb!]
%\centering
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real3d/Fig/real-pws2-0}
%  \label{fig:real-pws2-0}}
%  \subfloat[]{\includegraphics[width=0.45\textwidth]{real3d/Fig/real-pws2-0}
%  \label{fig:real-pws2-0}}
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real3d/Fig/real-pws3-0}
...
%\begin{figure}[htb!]
%\centering
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real3d/Fig/real-pws2-n-0}
%  \label{fig:real-pws2-n-0}}
%  \subfloat[]{\includegraphics[width=0.45\textwidth]{real3d/Fig/real-pws1-n-0}
%  \label{fig:real-pws1-n-0}}
%\subfloat[]{\includegraphics[width=0.45\textwidth]{real3d/Fig/real-pws3-n-0}
...
\plot{real}{width=0.45\textwidth}{\new{3D field data example.} }

\plot{rect1}{width=0.45\textwidth}{\new{3D field data example. Non-stationary smoothing radius.}}

\multiplot{3}{real-s2dip1,real-s1dip1,real-ndip1}{width=0.45\textwidth}{\new{Slope comparison of the 3D field data example. (a) Slope estimated from the noisy data with a small constant smoothing radius $R=2$. (b) Slope estimated from the noisy data with a large constant smoothing radius $R=20$. (c) Slope estimated from the noisy data with non-stationary smoothing radius.}}


\multiplot{4}{real-pws2-0,real-pws1-0,real-pws3-0}{width=0.45\textwidth}{\new{Smoothing test of the field data example. (a) Structurally smoothed using the slope estimated from the noisy data with a small constant smoothing radius. (b) Structurally smoothed using the slope estimated from the noisy data with a large constant smoothing radius. (c) Structurally smoothed using the slope estimated from the noisy data with non-stationary smoothing radius. Note the difference highlighted by the arrows.}}



\multiplot{4}{real-pws2-n-0,real-pws1-n-0,real-pws3-n-0}{width=0.45\textwidth}{\new{Smoothing test of the field data example. (a)-(c) Removed noise corresponding to Figs. \ref{fig:real-pws2-0}-\ref{fig:real-pws3-0}. Note the difference highlighted by the arrows.}}
