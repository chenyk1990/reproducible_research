function [ D1 ] = drr5d_denoising_recon_synth(D,MASK,flow,fhigh,dt,N,NN,Niter,eps,verb,mode,a)
%  MSSA5D: multichannel singular spectrum analysis (MSSA) for 5D
...
%         U = P * diag(thresh(diag(Sigma),lam0/mu,a0,p)) * Q';
