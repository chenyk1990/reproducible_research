function [dout]=yc_sgk_recon(d0,mask,mode,l,s,perc,niter,a,param)
%yc_sgk_recon: SGK algorithm for 2D/3D reconstruction
% BY Yangkang Chen
% Jan, 2020
%
% INPUT
...
%   param.d0=d0;    %initial guess
%   param.init=1;   %init=1: using linear interpolation for initialization
%
% OUTPUT
% dout:
%
