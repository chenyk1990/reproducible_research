function [dout]=yc_ddtf_recon5d(d0,mask,mode,l,s,perc,niter,a,param)
...
%
% DEMO:
% test/test_yc_ddtf_recon.m
% test/test_yc_ddtf_recon3d.m
% test/test_yc_ddtf_recon4d.m
% test/test_yc_ddtf_recon5d.m
%
% References:
...
for iter=1:niter
    ...
    [Dddtf,Gddtf]=yc_ddtf(X,param);
    Gddtfc=Gddtf;
    Gddtf=yc_pthresh(Gddtfc,'ph',perc);
    X2=Dddtf*Gddtf;
