function [dout]=yc_ksvd_recon5d(d0,mask,mode,l,s,perc,niter,a,param)
%yc_ksvd_recon: K-SVD algorithm for 2D/3D reconstruction
% BY Yangkang Chen and Hang Wang
% Jan, 2020
% March, 2020
% Modified on April, 2020 (3D-4D/5D)
%
% INPUT
%   mode: patching mode
%   l: [l1,l2,l3,l4,l5]
...
%
% DEMO:
% test/test_yc_ksvd_recon.m
% test/test_yc_ksvd_recon3d.m
%
% References:
