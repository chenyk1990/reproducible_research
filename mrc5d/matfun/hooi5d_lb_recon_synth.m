function [ D1 ] = hooi5d_lb_recon_synth(D,MASK,flow,fhigh,dt,N,Niter,eps,verb,mode,type,a)
%  HOOI5D: higher-order orthogonal iteration (HOOI) for 5D
...
%  Modified by Yangkang Chen (2020)
%
...
%
%  Reference:   
%  Chen et al, 2016. Simultaneous denoising and reconstruction of 5-D seismic data via damped rank-reduction method, Geophysical Journal International, vol. 206, no. 3, pp. 1695–1717, 2016.
%  Kreimer and Sacchi, 2012. A tensor higher-order singular value decomposition for prestack seismic data noise reduction and interpolation, Geophysics, vol. 77, no. 3, pp. V113–V122, 2012

%addpath(genpath('~/chenyk.data2/various/packages/tensor_toolbox_2.4'));
